      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader className="text-center">
          ...
          <DialogDescription asChild>
            ...
            <p className="text-base text-black">I am charging a small amount of ₹49 for this workbook because creating it took a lot of time and energy. I am very confident that this workbook will help you become aware of your real passion and talent. It is truly worth it.</p>
            <p className="text-red-500 mt-2 text-base">Kindly take a printout of the PDF after you download it.</p>
            </div>
          </DialogDescription>
        </DialogHeader>
